		...
		extend: {
			colors: {
				...
				sales: {
					...
					success: 'hsl(var(--sales-success))',
					warning: 'hsl(var(--sales-warning))'
				}
			},
			backgroundImage: {
				'gradient-primary': 'linear-gradient(135deg, hsl(var(--sales-primary)), hsl(var(--sales-secondary)))',
				'gradient-success': 'linear-gradient(135deg, hsl(var(--sales-success)), hsl(var(--sales-accent)))',
